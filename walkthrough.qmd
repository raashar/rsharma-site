...
For the Senate race, we'll create a chart that shows the top 10 counties highest margins of victory for the Democratic candidate. To do that we'll need to compare the Democratic candidate's percentage (pct_d\_2022) with the Republican's (pct_r\_2022) to calculate the margin of victory for each county.
...
For the Senate race, we'll create a choropleth map that shows the margins of victory for the Democratic candidate. To do that we'll need to compare the Democratic candidate's percentage (pct_d\_2022) with the Republican's (pct_r\_2022) to calculate the margin of victory for each county.
